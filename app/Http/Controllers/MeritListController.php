...
class MeritListController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.merit_lists.index')->with('success', 'Merit added!');
    }
    ...
    public function update(Request $request, MeritList $meritList)
    {
        ...
        return redirect()->route('admin.merit_lists.index')->with('success', 'Updated!');
    }

    public function destroy(MeritList $meritList)
    {
        $meritList->delete();
        return redirect()->route('admin.merit_lists.index')->with('success', 'Deleted!');
    }
}